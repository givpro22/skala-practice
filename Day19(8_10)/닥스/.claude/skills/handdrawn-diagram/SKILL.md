...
text('통관 검토 의뢰 흐름', 40, 62, { size: 44, font: 'gaegu-bold', color: PALETTE.blue });

const fe  = box(60, 130, 220, 90, 'Vue\n프론트');
const gw  = rbox(360, 130, 250, 90, 'API Gateway', { color: PALETTE.green });
arrow(fe.right, fe.cy, gw.left, gw.cy, { label: '토큰 달고 요청' });

cylinder(480, 420, 160, 130, 'MariaDB');
person(90, 400, '수입기업 담당자');
circleMark(gw.cx, gw.cy, 300, 130, { color: PALETTE.red });
```
...
실습 아키텍처 전체(서비스 7개 + 인프라 4개)를 한 장에 넣으려는 충동이 가장 흔한 실패다.
