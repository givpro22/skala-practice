...
-- =====================================================================
-- 개선 요약:
--   MV 미사용(JOIN+SUM, 14,250행 집계): 약 19ms, Seq Scan×2 + HashAggregate
--   MV 사용(사전 집계 124행 조회)      : 약 0.02ms, Index Scan Backward
--   → 약 860배 단축(리포트 캡처 EXPLAIN 기준). 집계를 미리 계산해 전량 스캔·집계를 통째로 건너뜀.
